...
const productData: Product[] = [
  {
    ...
    price: "Rp 1.600.000",
    displayPrice: false,
    linkedTo: "/payment/sup-parenting",
  },
  {
...
export default function RecommendedCourse() {
  return (
    <Box id="products" py={24} px={{ base: 0, lg: 24 }}>
      <Flex
        w="full"
        py={4}
        direction="column"
      ...
      >
        <Heading mb={5} textAlign="center">
          <MarkText text="Product unggulan." mark="unggulan." variant="brand" />
        </Heading>
        <Text color="gray.400" maxW={520} textAlign="center">
